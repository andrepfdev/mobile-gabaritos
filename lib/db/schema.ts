...
export const exams = sqliteTable(
  ...
  (table) => [index('exams_user_id_idx').on(table.userId)],
);
...
export const answerKeys = sqliteTable(
  ...
  (table) => [index('answer_keys_user_id_idx').on(table.userId)],
);
...
export const classes = sqliteTable(
  ...
  (table) => [index('classes_user_id_idx').on(table.userId)],
);
...
export const students = sqliteTable(
  ...
  (table) => [index('students_user_id_idx').on(table.userId), index('students_class_id_idx').on(table.classId)],
);
...
export const examClasses = sqliteTable(
  ...
  (table) => [
    index('exam_classes_user_id_idx').on(table.userId),
    index('exam_classes_exam_id_idx').on(table.examId),
